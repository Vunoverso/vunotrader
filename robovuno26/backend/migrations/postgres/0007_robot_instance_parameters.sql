CREATE TABLE IF NOT EXISTS robot_instance_parameters (
    ...
    robot_instance_id BIGINT NOT NULL UNIQUE,
    ...
    performance_gate_min_profit_factor DOUBLE PRECISION NOT NULL DEFAULT 1.3,
    performance_gate_min_trades INTEGER NOT NULL DEFAULT 100,
    validated_backtest_profit_factor DOUBLE PRECISION NOT NULL DEFAULT 0,
