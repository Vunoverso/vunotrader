...
void CopyStringArray(const string &source[], string &target[])
{
...
void CollectTerminalSymbols(bool selectedOnly, string &symbols[])
{
   ...
   for(int i = 0; i < total; i++)
   {
      ...
      AddTrackedSymbol(symbols, symbol);
   }
}


string BuildJsonArrayFromSymbols(const string &symbols[])
{
   string json = "[";
